...
> **RULED 2026-07-21 (founder):** all six ratified per docs/research/warm-lead-q1-q6-recommendations-2026-07-21.md — Q2 enum widened (+out_of_office, +wrong_person; DNC→suppress); Q5: no EU/UK recipients in pilot, TTL = pre-GA gate. Note: tool numbering "20-23" predates the byo merge — live surface is 21, so the four new tools are 22-25.
