...
// allowlist as the platform's own outbound URL-safety guard — but unlike
// that guard, this WARNS rather than blocks: a self-hoster pointing
// AGENT_COLD_EMAIL_BASE_URL at their own http:// deployment is a
// deliberate, same-actor choice, not something the CLI should refuse to run.
...
export async function runMcp(): Promise<void> {
  ...
  // (measured 2-6.8s against a stub, 4-4.8s against production). The
  ...
  // process becomes an orphan after the client disconnects.
