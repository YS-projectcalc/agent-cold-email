...
// msgchannel Increment 4 — §9 T10. Same shape as test/unsubscribe.test.ts's
// own route tests (routes/unsubscribe.ts's precedent): the signed (tenant,
// email, sig) triplet in the query string IS the credential, verified with
// the SAME `verifyUnsubscribeToken` /unsubscribe already uses.
